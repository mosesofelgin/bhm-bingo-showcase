#!/usr/bin/env python3
"""
Generate expanded hero database with 45 additional Black historical figures
"""

additional_heroes = [
    # Civil Rights (13 more)
    {
        "id": 31,
    ...
    },
    {
        ...
        "imageUrl": "/images/heroes/mary-mcleod-bethune.jpg"
    },
    {
        "id": 34,
        "name": "Medgar Evers",
    ...
    },
    {
        ...
        "imageUrl": "/images/heroes/a-philip-randolph.jpg"
    },
    {
        "id": 38,
        "name": "Dorothy Height",
    ...
    # Business & Entrepreneurship (3 more)
    {
        "id": 64,
...
print("// Additional 45 heroes to expand database to 75 total")
print()
for hero in additional_heroes:
    print("  {")
    print(f"    id: {hero['id']},")
    print(f"    name: \"{hero['name']}\",")
    print(f"    bioSummary: \"{hero['bioSummary']}\",")
    print(f"    keyAccomplishment: \"{hero['keyAccomplishment']}\",")
    print(f"    era: \"{hero['era']}\",")
    print(f"    category: \"{hero['category']}\",")
    print(f"    bioFull: \"{hero['bioFull']}\",")
    print(f"    imageUrl: \"{hero['imageUrl']}\"")
    print("  },")

print(f"\n// Total heroes: 75")
print(f"// Categories: Civil Rights ({sum(1 for h in additional_heroes if h['category'] == 'Civil Rights')} added)")
print(f"// Science & Medicine ({sum(1 for h in additional_heroes if h['category'] == 'Science & Medicine')} added)")
print(f"// Arts & Culture ({sum(1 for h in additional_heroes if h['category'] == 'Arts & Culture')} added)")
print(f"// Business & Entrepreneurship ({sum(1 for h in additional_heroes if h['category'] == 'Business & Entrepreneurship')} added)")
print(f"// Politics & Law ({sum(1 for h in additional_heroes if h['category'] == 'Politics & Law')} added)")
print(f"// Sports ({sum(1 for h in additional_heroes if h['category'] == 'Sports')} added)")
print(f"// Military ({sum(1 for h in additional_heroes if h['category'] == 'Military')} added)")
